/* Populate tables */
INSERT INTO clientes (nombre, apellido, email, create_at, foto) VALUES('Adonis', 'Estolaza', 'Adonis.estolazam@outlook.com', '2017-08-01', '');
...
insert into users(username, password, enabled) values("adonis","$2a$10$41Vkl6spD1FzRVgua6ayhOO1M..hhMECF9nnWBgjv7TJqO/ZSlhNC",1);
insert into users(username, password, enabled) values("admin","$2a$10$qNZ7fuzMqYNY7JJekm/vFO1ntA723AzzqOrmpbzHgN/V7RS.abJiu",1);
